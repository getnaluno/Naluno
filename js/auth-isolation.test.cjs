...
assert.ok(adminSrc.includes("const BUILD = '20260922b'"), 'admin build 20260922b');
assert.ok(adminHtml.includes('2026.09.22b'), 'admin html build 2026.09.22b');
assert.ok(adminHtml.includes('admin-console.js?v=20260922b'), 'admin cache-bust');
