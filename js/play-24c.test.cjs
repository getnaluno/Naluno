...
assert.ok(html.includes('2026.09.24c'), 'member build stamp');
assert.ok(sw.includes('naluno-shell-v202'), 'the shell cache moves');
assert.ok(sw.includes("APP_BUILD = '20260924c'"), 'service worker build');
