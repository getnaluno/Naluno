...
if('serviceWorker' in navigator){
  navigator.serviceWorker.register('/sw.js?v=20260915d', { scope: '/', updateViaCache: 'none' })
  ...
  try{
    ...
    navigator.serviceWorker.addEventListener('controllerchange', function(){
      if(reloaded) return;
      try{ if(sessionStorage.getItem('nalunoSwReload') === '20260915d') return; }catch(_){}
      reloaded = true;
      try{ sessionStorage.setItem('nalunoSwReload', '20260915d'); }catch(_){}
      location.reload();
    });
  }catch(_){}
