...
if('serviceWorker' in navigator){
  navigator.serviceWorker.register('/sw.js?v=20260915b', { scope: '/', updateViaCache: 'none' })
  ...
  try{
    ...
    navigator.serviceWorker.addEventListener('controllerchange', function(){
      if(reloaded) return;
      try{ if(sessionStorage.getItem('nalunoSwReload') === '20260915b') return; }catch(_){}
      reloaded = true;
      try{ sessionStorage.setItem('nalunoSwReload', '20260915b'); }catch(_){}
      location.reload();
    });
  }catch(_){}
