...
(function bindBcastViewTabs(){
  ...
  function ignoreTarget(el){
    ...
    if(el.closest('#bcastSearchRow, input, textarea, select, button, .join-btn, .signal-tile-create, #newBroadcastBtn, #broadcastGoLiveBtn, #composer, #bcomposer, #bcompPickWrap, #uploadDrop, .strand-rail, .feed-orient-btn, .toga-list, #togaBoard, .bcast-strip, #myBcastStrip')) return true;
    return false;
  }
  function onDown(e){
